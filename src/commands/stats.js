...
const { generateStatsImage } = require('../utils/chartGenerator');

module.exports = {
    data: new SlashCommandBuilder()
        .setName('stats')
        .setDescription('Affiche les statistiques avancées d\'un utilisateur')
    ...
    async execute(interaction) {
        ...
        try {
            ...
            // Generate Image
            const buffer = await generateStatsImage(targetUser, stats, history, topChannels);
